...
Полная версия документации на русском. Короткая страница проекта —
[в корне репозитория](../README.md).

<img src="expanded.png" width="620" alt="Развёрнутая панель MacPulse">
...
<img src="windows-popover.png" width="620" alt="Список окон приложения: у каждого окна кнопка «Закрыть», ниже процессы группы без кнопок">
